...
Pour la mesure du diamètre du nerf optique comme de la gaine, la mesure par la technique *habituelle* est systématiquement plus haute (d'environ 0,2 mm) que par la technique *Interface vitrée*. 
